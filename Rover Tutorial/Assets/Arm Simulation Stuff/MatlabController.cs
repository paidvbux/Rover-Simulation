...
public class MatlabController : MonoBehaviour
{
    ...
    void FixedUpdate()
	{
		...
		controlSensorSignal.sensorOutput[21] = robot.transform.position.x - robotController.origin.position.x;
		controlSensorSignal.sensorOutput[22] = robot.transform.position.z - robotController.origin.position.z;
		controlSensorSignal.sensorOutput[23] = robot.transform.position.y - robotController.origin.position.y;
		controlSensorSignal.sensorOutput[24] = endEffector.position.x - robotController.origin.position.x;
		controlSensorSignal.sensorOutput[25] = endEffector.position.z - robotController.origin.position.y;
		controlSensorSignal.sensorOutput[26] = endEffector.position.y - robotController.origin.position.z;
		controlSensorSignal.sensorOutput[27] = robotController.origin.position.x;
		controlSensorSignal.sensorOutput[28] = robotController.origin.position.z;
		controlSensorSignal.sensorOutput[29] = robotController.origin.position.y;
	}
